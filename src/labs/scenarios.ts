...
/** Scenario configs for the generic ScenarioLab engine, keyed by labId. */
export const SCENARIOS: Record<string, ScenarioConfig> = {
  ...
  crosswalk: {
    ...
    brief: '🔗 One control, many frameworks. Match each artifact to the framework it belongs to.',
    steps: [
      {
